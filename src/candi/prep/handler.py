# Vendored VERBATIM from /project/6014832/mforooz/EpiDenoise/data.py lines 1-1964 (CANDIDataHandler), with edits E1-E5 (see candi/.BUILD_PLAN.md).
import pandas as pd
import numpy as np
import torch
import os
...
class CANDIDataHandler:
    def __init__(self, base_path, side, includes, resolution=25, dataset_type="eic", DNA=True,
        ...
        self.merge_ct = False
        self.eic = True
        state_dir = os.path.join(self.base_path, ".candi_state")
