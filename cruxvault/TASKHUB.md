...
- `t4` [data-acquisition] obtain the real ENCODE hg38 blacklist v2
- `t5` [data-acquisition] recover metadata for the 361 chipseq-control tracks missing from the metadata CSVs
- `t6` [implementation] candi.store writer: per-biosample (bins x tracks) h5 layout, dtypes, manifest from the metadata CSVs

## Blocked

- `t7` [implementation] candi.store genome layer: dna.h5 base codes and mask.h5 valid-bin mask — blocked by `t4`
...
- `t4` [data-acquisition] obtain the real ENCODE hg38 blacklist v2 — *open*
- `t5` [data-acquisition] recover metadata for the 361 chipseq-control tracks missing from the metadata CSVs — *open*
...
- `t7` [implementation] candi.store genome layer: dna.h5 base codes and mask.h5 valid-bin mask — *blocked*
