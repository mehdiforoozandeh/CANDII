...
| the CANDI_STORE corpus store — how to use it, layout, codecs, manifest | `STORE.md` |
| what `candi.bench` and `candi.monitor` measure, the keys they write, quoting rules | `EVAL.md` |
